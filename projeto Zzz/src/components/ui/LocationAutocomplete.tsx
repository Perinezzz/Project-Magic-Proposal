...
const LOCATIONS_DATABASE = [
  ...
  { name: 'Fernando de Noronha', code: 'FEN', country: 'Brasil', type: 'destination' },
  ...
  { name: 'Foz do Iguaçu', code: 'IGU', country: 'Brasil', type: 'destination' },
  ...
  { name: 'Chapada Diamantina', code: '', country: 'Brasil', type: 'destination' },
  { name: 'Lençóis Maranhenses', code: '', country: 'Brasil', type: 'destination' },
  ...
  { name: 'San Francisco', code: 'SFO', country: 'Estados Unidos', type: 'city' },
  { name: 'Chicago', code: 'ORD', country: 'Estados Unidos', type: 'city' },
  { name: 'Washington D.C.', code: 'IAD', country: 'Estados Unidos', type: 'city' },
  { name: 'Boston', code: 'BOS', country: 'Estados Unidos', type: 'city' },
  { name: 'Havaí', code: 'HNL', country: 'Estados Unidos', type: 'destination' },
  ...
  { name: 'Playa del Carmen', code: 'CUN', country: 'México', type: 'destination' },
  ...
  { name: 'Punta del Este', code: 'PDP', country: 'Uruguai', type: 'destination' },
  ...
  { name: 'Costa Amalfitana', code: 'NAP', country: 'Itália', type: 'destination' },
  ...
  { name: 'Queenstown', code: 'ZQN', country: 'Nova Zelândia', type: 'destination' },
  { name: 'Fiji', code: 'NAN', country: 'Fiji', type: 'destination' },
  { name: 'Bora Bora', code: 'BOB', country: 'Polinésia Francesa', type: 'destination' },
  { name: 'Tahiti', code: 'PPT', country: 'Polinésia Francesa', type: 'destination' },

  // Ilhas e Destinos Exóticos
  { name: 'Maldivas', code: 'MLE', country: 'Maldivas', type: 'destination' },
  { name: 'Ilhas Maurício', code: 'MRU', country: 'Maurício', type: 'destination' },
  { name: 'Seychelles', code: 'SEZ', country: 'Seychelles', type: 'destination' },
  ...
  { name: 'Turks and Caicos', code: 'PLS', country: 'Turks and Caicos', type: 'destination' },
  { name: 'Bahamas', code: 'NAS', country: 'Bahamas', type: 'destination' },
  { name: 'Jamaica', code: 'MBJ', country: 'Jamaica', type: 'destination' },
  { name: 'Punta Cana', code: 'PUJ', country: 'República Dominicana', type: 'destination' },
  { name: 'St. Martin', code: 'SXM', country: 'St. Martin', type: 'destination' },

  // África
  { name: 'Cidade do Cabo', code: 'CPT', country: 'África do Sul', type: 'city' },
  { name: 'Joanesburgo', code: 'JNB', country: 'África do Sul', type: 'city' },
  { name: 'Safari Kruger', code: 'MQP', country: 'África do Sul', type: 'destination' },
